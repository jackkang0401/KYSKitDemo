//
//  UIDevice+KYSDeviceInformation.m
//  KYSKitDemo
//
...
#import "UIDevice+KYSDeviceInformation.h"
...
@implementation UIDevice (KYSDeviceInformation)
...
#else
    NSString *path = [NSString stringWithFormat:@"/private/%@", [self p_stringWithUUID]];
#endif
